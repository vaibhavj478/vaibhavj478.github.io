    ...
    <>
      ...
      <nav  style={{backgroundColor:`${navColor}`}} ref={ref} className="navbarMainContainer">
        ...
        <div className="navbarMainResponse">
          {windowSize < 800 ? (
            ...
            <>
              <section id="two">
                <div onClick={()=> window.scrollTo({top: pageState.home,  behavior: 'smooth' })} className="maindiv">
                  {" "}
                  <span>Home</span>
                </div>
                <div onClick={ ()=> window.scrollTo({top: pageState.about,  behavior: 'smooth' })} className="maindiv">
                  {" "}
                  <span>About</span> 
                </div>
                <div onClick={()=> window.scrollTo({top: pageState.project,  behavior: 'smooth' })} className="maindiv">
                  Project
                </div>
                <div onClick={()=> window.scrollTo({top: pageState.skill,  behavior: 'smooth' })} className="maindiv">
                  Technology
                </div>
                <div  onClick={()=> window.scrollTo({top: pageState.contact,  behavior: 'smooth' })}  className="maindiv">
                  Contact
                </div>
      ...
      {!menu && windowSize < 800 ? (
        <div className="menuSmallPage">
          <section id="two">
            <div id="homeNav" onClick={(e) => handleCloseMenu(e)} className="maindiv">
              {" "}
              <span>Home</span>
            </div>
            <div  id ='aboutNav' onClick={(e) => handleCloseMenu(e)} className="maindiv">
              {" "}
              <span>About</span> 
            </div>
            <div
